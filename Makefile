...
ACLOCAL = ${SHELL} '/home/user/very-very-very-very-long-directory-name-tools/ucon/ucon/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/user/very-very-very-very-long-directory-name-tools/ucon/ucon/missing' autoconf
AUTOHEADER = ${SHELL} '/home/user/very-very-very-very-long-directory-name-tools/ucon/ucon/missing' autoheader
AUTOMAKE = ${SHELL} '/home/user/very-very-very-very-long-directory-name-tools/ucon/ucon/missing' automake-1.16
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/user/very-very-very-very-long-directory-name-tools/ucon/ucon/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = ucon
PACKAGE_BUGREPORT = www.sourceforge.net
PACKAGE_NAME = ucon
PACKAGE_STRING = ucon 24.0224
PACKAGE_TARNAME = ucon
PACKAGE_URL = 
PACKAGE_VERSION = 24.0224
PATH_SEPARATOR = :
RANLIB = ranlib
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
VERSION = 24.0224
abs_builddir = /home/user/very-very-very-very-long-directory-name-tools/ucon/ucon
abs_srcdir = /home/user/very-very-very-very-long-directory-name-tools/ucon/ucon
abs_top_builddir = /home/user/very-very-very-very-long-directory-name-tools/ucon/ucon
abs_top_srcdir = /home/user/very-very-very-very-long-directory-name-tools/ucon/ucon
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/user/very-very-very-very-long-directory-name-tools/ucon/ucon/install-sh
