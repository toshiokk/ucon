...
pkgdatadir = $(datadir)/ucon
pkgincludedir = $(includedir)/ucon
pkglibdir = $(libdir)/ucon
pkglibexecdir = $(libexecdir)/ucon
...
am__v_CXXLD_1 = 
SOURCES = $(ucon_SOURCES)
DIST_SOURCES = $(ucon_SOURCES)
...
ACLOCAL = ${SHELL} '/media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src/missing' autoconf
AUTOHEADER = ${SHELL} '/media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src/missing' autoheader
AUTOMAKE = ${SHELL} '/media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src/missing' automake-1.16
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = ucon
PACKAGE_BUGREPORT = www.sourceforge.net
PACKAGE_NAME = ucon
PACKAGE_STRING = ucon 23.0114
PACKAGE_TARNAME = ucon
PACKAGE_URL = 
PACKAGE_VERSION = 23.0114
PATH_SEPARATOR = :
RANLIB = ranlib
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
VERSION = 23.0114
abs_builddir = /media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src
abs_srcdir = /media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src
abs_top_builddir = /media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src
abs_top_srcdir = /media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /media/user/9086eda5-eb82-451b-8d0f-97b552a1c912/home/user/@mx-home-backups/tools/ucon/src/install-sh
...
ucon$(EXEEXT): $(ucon_OBJECTS) $(ucon_DEPENDENCIES) $(EXTRA_ucon_DEPENDENCIES) 
	@rm -f ucon$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(ucon_OBJECTS) $(ucon_LDADD) $(LIBS)
...
include ./$(DEPDIR)/mydebug.Po # am--include-marker
include ./$(DEPDIR)/myminmax.Po # am--include-marker
include ./$(DEPDIR)/mystring.Po # am--include-marker
include ./$(DEPDIR)/myutf8.Po # am--include-marker
include ./$(DEPDIR)/pen.Po # am--include-marker
include ./$(DEPDIR)/picofont.Po # am--include-marker
include ./$(DEPDIR)/term.Po # am--include-marker
include ./$(DEPDIR)/util.Po # am--include-marker
include ./$(DEPDIR)/vterm.Po # am--include-marker
include ./$(DEPDIR)/vtermlow.Po # am--include-marker
...
distclean: distclean-am
	...
	-rm -f ./$(DEPDIR)/mydebug.Po
	-rm -f ./$(DEPDIR)/myminmax.Po
	-rm -f ./$(DEPDIR)/mystring.Po
	-rm -f ./$(DEPDIR)/myutf8.Po
	-rm -f ./$(DEPDIR)/pen.Po
	-rm -f ./$(DEPDIR)/picofont.Po
	-rm -f ./$(DEPDIR)/term.Po
	-rm -f ./$(DEPDIR)/util.Po
	-rm -f ./$(DEPDIR)/vterm.Po
	-rm -f ./$(DEPDIR)/vtermlow.Po
	-rm -f Makefile
